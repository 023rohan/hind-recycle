...
!(function () {
  ...
  function c(t, n, i) {
    (t =
      ...
      document.documentElement).insertBefore(i, t.lastChild);
  }
  function i(t) {
  ...
  ($.prototype.g = function (t) {
      ...
      (this.c = new n(this.j, t.context || this.j)),
        ...
        (function (o, t, n) {
          var i = [],
            e = n.timeout;
          !(function (t) {
            t.g && d(t.f, [t.a.c("wf", "loading")]), S(t, "loading");
          })(t);
          i = (function (t, n, i) {
            var e,
              o = [];
    ...
    (z.prototype.load = function (t) {
      var n,
        ...
        s = new g();
      for (n = 0, i = e.length; n < i; n++) h(this.c, e[n], v(s));
      var r = [];
...
/*!This file is auto-generated*/ window.addComment = (function (f) {
  var v,
    I,
    C,
    h = f.document,
...
!(function (t, e) {
  ...
  function l(t, e, n) {
    var r, o;
    e.constructor === t.constructor && n === s && e.constructor.resolve === u
      ? ((r = t),
        (o = e)._state === K
          ? p(r, o._result)
          : o._state === L
  ...
  function p(t, e) {
    t._state === D &&
      ((t._result = e), (t._state = K), 0 !== t._subscribers.length && M(v, t));
  }
  function _(t, e) {
    t._state === D && ((t._state = L), (t._result = e), M(r, t));
  }
  function d(t, e, n, r) {
  ...
  function v(t) {
    var e = t._subscribers,
      n = t._state;
    if (0 !== e.length) {
      for (var r, o = void 0, i = t._result, s = 0; s < e.length; s += 3)
  ...
  function y(t, e, n, r) {
    ...
    e._state !== D ||
      (o && u ? h(e, i) : c ? _(e, s) : t === K ? p(e, i) : t === L && _(e, i));
  }
  function m(t) {
    (t[F] = W++),
      (t._state = void 0),
  ...
  function o(t, e) {
    (this._instanceConstructor = t),
      ...
      j(e)
        ...
        : _(this.promise, new Error("Array Methods must be provided an Array"));
  }
  function b(t) {
    (this[F] = W++),
  ...
  var w,
    ...
    T = void 0,
    M = function (t, e) {
      (k[E] = t), (k[E + 1] = e), 2 === (E += 2) && (T ? T(n) : q());
    },
    x = "undefined" != typeof window ? window : void 0,
    C = x || {},
    O = C.MutationObserver || C.WebKitMutationObserver,
    Y =
    ...
    q = Y
      ...
      : C
      ? (((w = new MessageChannel()).port1.onmessage = n),
        function () {
  ...
  return (
    ...
    (o.prototype._eachEntry = function (e, t) {
      ...
      i === u
        ? (n = f(e)) === s && e._state !== D
          ...
          : o === b
          ? (l((r = new o(c)), e, n), this._willSettleAt(r, t))
          : this._willSettleAt(
              new o(function (t) {
                return t(e);
              }),
    ...
    (o.prototype._settledAt = function (t, e, n) {
      var r = this.promise;
      r._state === D &&
        (this._remaining--, t === L ? _(r, n) : (this._result[e] = n)),
  ...
  (function (l) {
    ...
    var n,
      ...
      t =
        ...
        (d = !(u = {})),
        (c = jQuery(".tatsu-animate, .be-animate")),
        (y = jQuery(".be-skill")),
        (f = jQuery(".tatsu-animated-heading-wrap")),
        (p = c.length),
        (s = 0),
        (m = jQuery(".tatsu-an")),
        (g = c.length + m.length),
        ...
        0 < (i = jQuery(".tatsu-column-sticky")).length &&
        ...
        (v = function (e, t) {
          (i = jQuery(".tatsu-column-sticky")).length &&
            asyncloader.require("stickykit", function () {
              var a = 0;
              jQuery("#wpadminbar").length && (a = 32),
                jQuery.each(i, function (e, t) {
                  t = jQuery(t);
                  767 < jQuery(window).width() &&
                  !t.closest(".tatsu-eq-cols").length
                    ? (t
                        .stick_in_parent({
                          parent: ".tatsu-row",
                          offset_top: a,
                      ...
                      t.parent().css("position", "static"))
                    : t.trigger("sticky_kit:detach");
                });
            });
          t = jQuery(".be-pb-observer-" + t + " .tatsu-column-inner ");
          t.hasClass("tatsu-column-sticky") || t.trigger("sticky_kit:detach");
        }),
        (T = function (e, t) {
          E(), v(e, t), D(e, t);
        }),
            ...
            e
              ...
              : 0 < s.length &&
                s
                  ...
                  .css("opacity", 1);
          (t = s.attr("data-active-colors")),
            (e = s.attr("data-normal-colors"));
          e &&
            ((e = JSON.parse(e)),
            s
              .find(".ui-state-default")
              .css({ color: e.color || "", background: e.background || "" })),
            t && s.find(".ui-state-active").css(JSON.parse(t));
        }),
        l(window).on("resize", Y),
        (j = Y),
        (Q = function (e) {
            ...
            0 < (e = l(".tatsu-bg-lazyload")).length &&
              ...
              jQuery(document).on(
                ...
                function (e) {
                  var t,
                    ...
                    i = jQuery(this);
                  "mouseenter" === e.type
                    ? ((a = i.attr("data-hover-color") || ""),
                      i.hasClass("be-style1")
                        ? ((t = i.attr("data-border-color")),
                          i.css({
                            borderColor: "",
                            backgroundColor: t,
                            color: a,
              ...
              document.body.addEventListener("touchstart", function (e) {
                e.target.closest(".flickity-slider")
                  ? ((i = !0),
                    (a = { x: e.touches[0].pageX, y: e.touches[0].pageY }))
                  : (i = !1);
              }),
              ...
              O(),
              0 < (s = l(".tatsu-line-animate")).length &&
              ...
              jQuery("body").hasClass("be-sticky-sections") || x(),
              I(),
              S(),
              w(),
              k(),
              ...
              (u.tatsu_accordion = Q),
              (u.tatsu_lists = j),
              (u.tatsu_typed_text = k),
              (u.tatsu_animated_heading = C),
                ...
                (c = jQuery(".tatsu-animate, .be-animate")),
                  ...
                  "trigger_ready" == t.moduleName
                    ? (_(),
                      ...
                      jQuery(window).trigger("resize"))
                    : t.moduleName in u &&
                      u[t.moduleName](t.shouldUpdate, t.moduleId),
                  "csstrigger" === t.type &&
                    ...
                    (n = a.animationDelay),
                    (r = jQuery(".be-pb-observer-" + t)).length &&
                      (r.removeClass(
              ...
              jQuery(window).on("resize.tatsu", function () {
                jQuery(".tatsu-bg-video, .be-bg-video").tatsuResizeMedia(),
                  r.hasClass("be-sticky-sections") &&
                    (window.innerWidth <= 960 && null == n
                      ? P()
        ...
        asyncloader.require("countTo", function () {
          m.each(function (e, t) {
            ...
            (t = jQuery(t)).hasClass("animate") &&
              (t.isVisible(!0) || r.hasClass("tatsu-frame")) &&
              (t.removeClass("animate"),
              (a = Number(t.attr("data-number"))),
              t.countTo({ from: 0, to: a, speed: 1500, refreshInterval: 30 }),
              g <= ++s && clearTimeout(n));
          });
        });
    }
    function x(e, t, a) {
      0 < p &&
        (null != a
          ...
          var a, i;
          (t = jQuery(t)).hasClass("already-visible") ||
            ((a = t.attr("data-animation-delay")),
            ...
            t.isVisible(!0) &&
              40 < o.innerHeight() - t[0].getBoundingClientRect().top &&
              (t.addClass("already-visible"),
              t.addClass(t.attr("data-animation")),
              g <= ++s && !r.hasClass("tatsu-frame") && clearInterval(n)));
        });
    }
    function I() {
    ...
    function q() {
      var e = l(".be-vimeo-embed"),
        t = l(".be-youtube-embed"),
        n = function (e) {
          asyncloader.require(["fitvids"], function () {
            null != e &&
              0 < e.length &&
          ...
          e.each(function () {
            var e = l(this),
              ...
              a =
                null != e.attr("data-autoplay") &&
                parseInt(e.attr("data-autoplay")),
              i = null != e.attr("data-loop") && parseInt(e.attr("data-loop"));
            null != t &&
              new Vimeo.Player(this, {
                id: t,
                autoplay: !!a,
          ...
          jQuery(".tatsu-gmap").each(function () {
            var e = jQuery(this).attr("data-address"),
              ...
              n = {
                ...
                scaleControl: !1,
                streetViewControl: !1,
                center: new google.maps.LatLng(parseFloat(a), parseFloat(i)),
                styles: r[n],
              },
              n = new google.maps.Map(jQuery(this)[0], n);
            new google.maps.Marker({
              position: new google.maps.LatLng(parseFloat(a), parseFloat(i)),
              map: n,
              title: e,
              icon: s,
            }).setMap(n);
    ...
    function A() {
      var e = y.closest(".skill_container");
      0 < e.length &&
        e.each(function () {
          var e;
          jQuery(this).hasClass("skill-vertical")
            ? ((e = 100 / jQuery(this).find(".skill-wrap").length + "%"),
              jQuery(this)
                .find(".skill-wrap")
                .css("width", e)
                .css("display", "block"))
        ...
        function t(e) {
          ...
          return (
            ...
            ((t = isNaN(Number(e.attr("data-cols")))
              ? 1
              : Number(e.attr("data-cols"))),
            (e = e.find(".be-slide").length),
            1024 < o.width() ? t < e : 767 < o.width() ? 2 < e : 1 < e)
          );
        }
        t(e) || e.addClass("be-slider-hide-nav"),
        ...
        asyncloader.require("flickity", function () {
          e.each(function () {
            var e,
              ...
              s,
              n = jQuery(this);
            n.hasClass("flickity-enabled") ||
              (("1" != n.attr("data-arrows") && "1" != n.attr("data-dots")) ||
                r(n),
              "1" == n.attr("data-arrows") &&
                "1" == n.attr("data-outer-arrows") &&
                (i = n) instanceof l &&
                0 < i.length &&
                !i.hasClass("be-slider-with-margin") &&
                100 < o.width() - i.outerWidth() &&
                ((s = isNaN(i.attr("data-gutter"))
                  ? 0
                  : Number(i.attr("data-gutter")) / 2),
                i.css({ padding: "0 50px", margin: "0 -" + (50 + s) + "px" })),
              "1" == n.attr("data-equal-height") &&
                (e = n) instanceof l &&
                0 < e.length &&
                ((t = 0),
                (a = e.find(".be-slide")).each(function () {
                  var e = l(this);
                  t < e.height() && (t = e.height());
                }),
                a.height(t),
              ...
              n.flickity({
                cellAlign:
                  null != n.attr("data-cell-align")
                    ? n.attr("data-cell-align")
                    : "left",
                contain: !0,
                lazyLoad:
                  "1" == n.attr("data-lazy-load") &&
                  ((a = 1),
                  (e = n) instanceof l &&
                    0 < e.length &&
                    1 <
                      (e = isNaN(Number(e.attr("data-cols")))
                        ? 1
                        : Number(e.attr("data-cols"))) &&
                    (a = e - 1),
                  a),
                adaptiveHeight: "1" == n.attr("data-adaptive-height"),
                pageDots: "1" == n.attr("data-dots"),
                prevNextButtons: "1" == n.attr("data-arrows"),
                asNavFor:
                  null != n.attr("data-as-nav-for") &&
                  n.attr("data-as-nav-for"),
                autoPlay:
                  !isNaN(Number(n.attr("data-auto-play"))) &&
                  Number(n.attr("data-auto-play")),
                wrapAround: "1" == n.attr("data-infinite"),
              }));
          });
        });
    }
    ...
    function D(t, a) {
      var i = jQuery(".tatsu-column-effect-tilt > div");
      asyncloader.require("tilt", function () {
        var e;
        t
          ? (e = jQuery(".be-pb-observer-" + a)).hasClass(
              "tatsu-column-effect-tilt"
            )
            ? e.children().tilt()
            : (e = e.children().eq(0).tilt()).tilt.destroy.call(e)
          : i.tilt({ scale: 1.1, perspective: 1e3, speed: 4e3, maxTilt: 10 });
      });
    }
    function L() {
      function e() {
        ...
        e.each(function () {
          ...
          e.one("load", function () {
            ...
            null != e.attr("data-srcset")
              ...
              : null != e.attr("data-src") && e.attr("src", e.attr("data-src")),
            this.complete && e.load();
        }),
          (t = t.not(e));
      }
      var t = jQuery(".tatsu-image-lazyload img");
      o.on("scroll", e), e();
    }
    function P() {
      (((0 < c.length || 0 < m.length) &&
        (!r.hasClass("be-sticky-sections") || window.innerWidth <= 960)) ||
        r.hasClass("tatsu-frame")) &&
        (n = setInterval(function () {
          d && ((d = !1), x(), _());
        }, 100)),
        r.hasClass("be-sticky-sections") && window.innerWidth <= 960 && x();
    }
    function Y() {
      l(".tatsu-lists-timeline").each(function () {
        var e,
          t,
          a = l(this),
          i = l(this).find(".tatsu-lists-timeline-element"),
          s = a.find(".tatsu-list-content").first().outerHeight() / 2;
        a.hasClass("tatsu-list-vertical-align-top")
          ? ((t = a.find(".tatsu-list-content").first().offset().top + 15),
            (e = a.find(".tatsu-list-content").last().offset().top + 15),
            (s = 15))
          : a.hasClass("tatsu-list-vertical-align-center")
          ? ((s = a.find(".tatsu-list-content").first().outerHeight() / 2),
            (t =
              a.find(".tatsu-list-content").first().offset().top +
              a.find(".tatsu-list-content").first().outerHeight() / 2),
            (e =
              a.find(".tatsu-list-content").last().offset().top +
              a.find(".tatsu-list-content").last().outerHeight() / 2))
          : a.hasClass("tatsu-list-vertical-align-bottom")
          ? ((s = a.find(".tatsu-list-content").first().outerHeight() - 15),
            (t =
              a.find(".tatsu-list-content").first().offset().top +
              a.find(".tatsu-list-content").first().outerHeight() -
              15),
            (e =
              a.find(".tatsu-list-content").last().offset().top +
              a.find(".tatsu-list-content").last().outerHeight() -
              15))
          : ((t = a.find(".tatsu-list-content").first().offset().top + 15),
            (e = a.find(".tatsu-list-content").last().offset().top + 15),
            (s = 15)),
          (t = e - t) && i.css({ height: t, top: s });
      });
    }
    (window.tatsu = t), jQuery(t.ready);
  })(jQuery);
...
!(function (l) {
  ...
  function a() {
    if (
      ...
      var t,
        ...
        a,
        i,
        n = jQuery("#be-content .tatsu-section:first-child .tatsu-section-pad"),
        r = 0,
        ...
        (e = parseInt(t.d.split(" ")[0])),
          ...
          (r =
            1377 < jQuery(window).width()
              ? e + u - o
              : 1024 < jQuery(window).width() && jQuery(window).width() <= 1377
              ? s + u - o
              : 768 <= jQuery(window).width() && jQuery(window).width() <= 1024
              ? a + u - o
              : i + u - o),
          n.css("padding-top", r);
      }
  ...
  var o,
    ...
    T =
      ...
      (r = l(".tatsu-header")),
      n.height(),
      (u = l("#tatsu-header-placeholder")),
      (w = n.height()),
      (C = n.hasClass("transparent")),
      tatsuFrontendConfig.pluginUrl,
      (j = n.hasClass("smart")),
      (Q = n.hasClass("sticky")),
      (v = 0),
      ...
      (b = n.height() + 200),
      (k = l(".tatsu-hamburger")),
      (_ = l(".tatsu-slide-menu")),
      (H = l("#tatsu-fixed-overlay")),
      (I = {}),
      ...
      }),
      {
        ready: function () {
          ...
          a(),
            ...
            y.hasClass("tatsu-header-single-page-site") && O(),
            N(),
            k.on("click", function () {
            ...
            U(),
            (t = jQuery(".tatsu-search")),
            (s = jQuery(".tatsu-wpml-lang-switcher")),
            jQuery(document).on("click", function (e) {
              e = jQuery(e.target);
              !e.closest(".tatsu-search").length && t.hasClass("search-open")
                ? t.removeClass("search-open")
                : !e.closest(".tatsu-wpml-lang-switcher").length &&
                  s.hasClass("language-switcher-open") &&
                  s.removeClass("language-switcher-open");
            }),
            (I.tatsu_sidebar_navigation_menu = M),
            (I.tatsu_navigation_menu = W),
            (I.tatsu_wpml_language_switcher = U),
            jQuery(window).on("tatsu_update.tatsu", function (e, t) {
              t.moduleName in I && I[t.moduleName](t.shouldUpdate, t.moduleId);
            }),
  ...
  function P() {
    var e = _.filter(function () {
      return l(this).hasClass("open");
    });
    k.find(".line-wrapper").removeClass("open"),
      H.removeClass("open"),
      e.removeClass("open");
  }
  function F() {
      ...
      e.superfish("destroy"),
        e.superfish({
          ...
          onBeforeShow: function () {
            var e, t, s, a, i, n, r;
            this.parent("li").hasClass("mega-menu")
              ? (this.css("visibility", "hidden"),
                ...
                e < 0 || t < e + i
                  ? ((t = i - (t - 30 - r)),
                    a.css("left", -t),
                    s.css("left", 20 + t))
                  : (s.css("left", i / 2 - s.width() / 2),
                    a.css("left", n / 2 - i / 2)),
                this.css("visibility", "visible"),
                this.fadeOut())
              : ((s = this.parents("ul").length),
                (a = this.closest("li.menu-item-has-children")),
                (n = s * (i = this.innerWidth())),
                (r =
                  i -
  ...
  function M() {
    ...
    jQuery(".tatsu-slide-menu li.mega-menu").removeClass("mega-menu"),
      (e = jQuery(".tatsu-sidebar-menu")).each(function () {
        e.css("width", jQuery(this).closest(".tatsu-slide-menu-col").width());
      });
  }
  function N() {
  ...
  function U() {
    jQuery(document).on("click", ".tatsu-wpml-lang-switcher", function (e) {
      e.stopPropagation(), jQuery(this).toggleClass("language-switcher-open");
    });
  }
  function W() {
    F(), N();
  }
  (window.tatsuHeader = T), l(T.ready);
})(jQuery);
!(function (l) {
  "use strict";
  function o(t) {
